...
const Contact = ({ isDarkMode }) => {
  ...
  const focusHandler = (name, isDarkMode) => {
    ...
    if (inputRef) {
      ...
      inputRef.parentElement.classList.add(isDarkMode ? Styles.focusedDark : Styles.focusedLight);
    }
  };
  ...
  const blurHandler = (name, isDarkMode) => {
    ...
    if (inputRef && inputRef.value === '') {
      ...
      inputRef.parentElement.classList.remove(isDarkMode ? Styles.focusedDark : Styles.focusedLight);
    }
  };
  ...
  return (
    <div className={isDarkMode ? Styles.formContainerDark : Styles.formContainerLight} id='contactMe'>
      <div className={Styles.contentContainer}>
        ...
        <form onSubmit={submitHandler} className={Styles.formItems}>
          <fieldset className={`${isDarkMode ? Styles.fieldsetDark : Styles.fieldsetLight}`}>
            ...
            <input
              ...
              required
              className={isDarkMode ? Styles.firstNameDark : Styles.firstNameLight}
              ref={setRef(0)}
              autoComplete='off'
            />
          </fieldset>
          ...
          <fieldset className={`${isDarkMode ? Styles.fieldsetDark : Styles.fieldsetLight}`}>
            ...
            <input
              ...
              onChange={changeHandler}
              className={isDarkMode ? Styles.lastNameDark : Styles.lastNameLight}
              ref={setRef(1)}
              autoComplete='off'
              required
            />
